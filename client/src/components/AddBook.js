...
const AddBook = () => {
  ...
  const newAuthflagHandler = (e) => {
    ...
    } else if (e.target.value !== "" && bookName !== "" && genre !== "") {
              ...
              <td>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    authFlagNameHandler(e);
                  }}
                  disabled={NewAuthorFlag}
                />
              </td>
              <td>
                <label>Age: </label>
                <input
                  type="text"
                  onChange={(e) => {
                    setNewAuthorAge(e.target.value);
                    authFlagAgeHandler(e);
                  }}
                  disabled={NewAuthorFlag}
                />
              </td>
